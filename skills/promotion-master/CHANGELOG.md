...
## 0.1.0-preview.2（2026-09-25，受众版本）
- 内部、客户、两版配套成为明确选项；客户深度与范围另选。
- 客户正文直接面向读者，来源与条件保留，候选、自检和制作说明分离。
- 增加受众独立审阅与跨版本一致性验证，仍不自动发送或发布材料。

## 0.1.0-preview.1（2026-09-25，Promotion Master独立预览）
- 主入口更名，自包含研究、定位、问答与按需排版；默认十二问不扩展到局部任务。
- 增加判断提炼与成熟示范，区分研究判断和传播表达；基础正确与营销质量分开验收。
- 本轮待用户验收，不改变旧repo及旧安装。

以下为上游exec-deep-report历史，其版本及回滚标签属于原report-skills仓库。
